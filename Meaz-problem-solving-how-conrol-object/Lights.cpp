...
void setLightingAndShading() {
    ...
    GLfloat l0_pos[] = { 60.0, 50.0, 60, 1.0 }; // Position for LIGHT0
    ...
    GLfloat l1pos[] = { 60.0, 50.0, 60, 1.0 }; // Position for LIGHT1
    ...
    //GLfloat l1pos[] = { 10.0, 1.0, -0.5, 1.0 }; // Position for LIGHT1
    GLfloat l2pos[] = { 60.0, 50.0, 60, 1.0 }; // Position for LIGHT1
